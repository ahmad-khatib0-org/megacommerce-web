...
import ProductCreateDetailsWithVariations, { ProductVariationsForm } from "@/components/products/create/product-create-details-with-variations";
...
const ProductCreateDetails = ({ tr, hasVariations, reference }: Props) => {
  ...
  return (
    <div className="relative flex flex-col gap-y-4 w-full max-w-[800px] overflow-y-auto">
      {!hasVariations && <ProductCreateDetailsWithoutVariations
        ref={reference}
        tr={tr}
        productDetailsData={productDetailsData}
        lang={lang}
      />}
      {hasVariations && <ProductCreateDetailsWithVariations
        ref={reference}
        tr={tr}
        productDetailsData={productDetailsData}
        lang={lang}
