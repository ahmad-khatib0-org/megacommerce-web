...
} from '@megacommerce/proto/web/products/v1/product_list'
...
function HomeMoreToLike({ tr }: Props) {
  const items: ProductItem[] = [
    ...
    },
    {
      ...
      rating: 4.5,
      sold: 300,
      meta: [{ type: ProductItemMetadataType.BUNDLE, label: 'Buy 3 and get 2$ off' }],
    },
    {
      id: 'id',
      image: '/images/login.png',
      ...
      rating: 4.5,
      sold: 300,
      meta: [{ type: ProductItemMetadataType.BUNDLE, label: 'Buy 3 and get 1' }],
    },
    {
      id: 'id',
      image: '/images/login.png',
  ...
  const buildMetaItem = (meta: ProductItemMetadata, idx: number) => {
    switch (meta.type) {
      case ProductItemMetadataType.CUPON:
        return (
          <div key={idx} className='flex items-center gap-x-1 px-1'>
            <Image
