...
function SignupHooks({ tr, setImage }: Props) {
  ...
  const personalForm = useForm({
    ...
    validate: yupResolver(SignupHelpers.personalInfoForm(tr)),
    initialValues: SignupHelpers.personalInfoFormValues(),
  })
  ...
  return { personalForm, authForm, uppy, showSubmitButton, active, setActive, setShowSubmitButton }
}
